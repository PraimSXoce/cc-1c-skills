...
if ($defs.Count -gt 1) {
	Write-Error "JSON array with $($defs.Count) roles detected. role-compile accepts a single object per file. Split into separate JSON files and run once per role."
	exit 1
}
